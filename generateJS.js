...
if(process.argv[2] != '-db'){
  var sqlScript = fs.readFileSync(process.argv[2], "utf8")
...
function createDatabaseMetadata(){
  ...
  //  console.log(databaseMetadata);
    ...
    for(var i=0; i<databaseMetadata.tables.length; i++){
      var template = HTMLing.file("./generateJS.template.html");
...
//      console.log('--------------'+databaseMetadata.tables[i].dbName);
      ...
      fs.writeFileSync(databaseMetadata.name+'/'+databaseMetadata.tables[i].name+'.js', jsFile);
//      console.log(jsFile);
      console.log("The file was saved!");
    }


    var exampleAppTemplate = HTMLing.file("./generateAppJS.template.html");
    var exampleAppJSFile = exampleAppTemplate.render(databaseMetadata);
    fs.writeFileSync(databaseMetadata.name+'/'+'app'+'.js', exampleAppJSFile);
